            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="javascript:;" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="{{ asset('assets/logo.png') }}" alt="" height="17">
                        </span>
                    </a>
                ...
                <div class="d-flex justify-content-center align-items-center">
                    <img style="height: 35px" src="{{ asset('assets/logo.png') }}" alt="Logo PT. PAS">
                </div>
            </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{ asset('assets/logo.png') }}" alt="Header Avatar">
