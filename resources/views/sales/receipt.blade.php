...
<head>
    <meta charset="utf-8" />
    <title>Sale Receipt | Velzon Template</title>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="invoice-title">
                            <h4 class="float-end font-size-16">Receipt #{{ $sale->id }}</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mt-3 text-sm-end">
                                <address>
                                    ...
                                    {{ date('d M Y H:i:s', strtotime($sale->created_at)) }}<br><br>
                                </address>
                            </div>
                        </div>
                        <div class="mt-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end"><strong>
                                            Rp{{ number_format($sale->total, 0, ',', '.') }},-</strong></td>
                                        </strong></td>
                                    </tr>
                                </tbody>
                            </table>
